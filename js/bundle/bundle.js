	  ...
	  switch (name) {
	    case "Sun":
	      return (`
	        ...
	        <p><i><a href="https://en.wikipedia.org/wiki/Sun">Read more on Wikipedia</a></i></p>
	      `);
	    case "Mercury":
	      return (`
	        <h1>Mercury</h1>
	        ...
	        <p><i><a href="https://en.wikipedia.org/wiki/Mercury_(planet)">Read more on Wikipedia</a></i></p>
	      `);
	    case "Venus":
	      return (`
	        <h1>Venus</h1>
	        ...
	        <p><i><a href="https://en.wikipedia.org/wiki/Venus">Read more on Wikipedia</a></i></p>
	      `);
	    case "Earth":
	      return (`
	        <h1>The Earth</h1>
	        ...
	        <p><i><a href="https://en.wikipedia.org/wiki/Earth">Read more on Wikipedia</a></i></p>
	      `);
	    case "Mars":
	      return (`
	        <h1>Mars</h1>
	        ...
	        <p><i><a href="https://en.wikipedia.org/wiki/Mars">Read more on Wikipedia</a></i></p>
	      `);
	    case "Jupiter":
	      return (`
	        <h1>Jupiter</h1>
	        ...
	        <p><i><a href="https://en.wikipedia.org/wiki/Jupiter">Read more on Wikipedia</a></i></p>
	      `);
	    case "Saturn":
	      return (`
	        <h1>Saturn</h1>
	        ...
	        <p><i><a href="https://en.wikipedia.org/wiki/Saturn">Read more on Wikipedia</a></i></p>
	      `);
	    case "Uranus":
	      return (`
	        <h1>Uranus</h1>
	        ...
	        <p><i><a href="https://en.wikipedia.org/wiki/Uranus">Read more on Wikipedia</a></i></p>
	      `);
	    case "Neptune":
	      return (`
	        <h1>Neptune</h1>
	        ...
	        <p><i><a href="https://en.wikipedia.org/wiki/Neptune">Read more on Wikipedia</a></i></p>
	      `);
	    case "Pluto":
	      return (`
	        <h1>Pluto</h1>
	        ...
	        <p><i><a href="https://en.wikipedia.org/wiki/Pluto">Read more on Wikipedia</a></i></p>
	      `);
	    default:
	      return (``);
	  }
